...
- (void)layoutSubviews
{
    ...
    self.lastUpdateTimeLabel.frame = CGRectMake(lastUpdateX, lastUpdateY - 5 , lastUpdateWidth, lastUpdateHeight);
}
...
- (void)updateTimeLabel
{
    ...
    #pragma mark - 自己注释掉了
    // 3.显示日期
    self.lastUpdateTimeLabel.text = [NSString stringWithFormat:@"更新：%@", time];
}
